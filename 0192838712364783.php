...
.table thead th {
    font-size: 16px; /* Aumenta el tamaño de letra */
    font-weight: bold;
    padding: 14px; /* Espacio interno */
    background-color: #d0e7ff; /* Azul más notorio */
    color: #00264d; /* Azul oscuro para contraste */
    text-align: center;
...
.comentarios {
    max-width: 180px;      /* Limita el ancho */
            ...
            <i class="bi bi-eye me-1"></i> Ver todos
                ...
                <div class="accordion-item">
                    ...
                    <div id="usuariosMenu" class="accordion-collapse collapse" data-bs-parent="#menuAccordion">
                        <div class="accordion-body p-0">
                            <ul class="nav flex-column submenu">
                                <li class="nav-item"><a href="10294732894019238.php" class="nav-link" href="#">Gestion usuarios</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
