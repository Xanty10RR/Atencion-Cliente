...
function registrarAuditoria($pdo, $accion, $usuarioAfectadoId, $datosAntes, $datosDespues) {
    ...
    $stmt->execute([
        ...
        ':username_afectado' => $datosAntes['username'] ?? '',
...
$sql = "SELECT id, nombre_completo, documento, username, rol FROM Usuarios WHERE rol != '1'";
...
<div class="container">
    ...
    <div class="links">
        <a href='54874516871115.php'>➕ Crear Usuario</a> | 
